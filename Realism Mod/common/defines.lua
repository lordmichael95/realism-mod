...
NDiplomacy = {
	...
	ATTACKING_SOMEONE_CRUSADING_PIETY_COST = 150, -- Piety hit for attacking someone crusading
	ATTACKING_SOMEONE_DEFENDING_AGAINST_OTHER_RELIGIOUS_GROUP_PIETY_COST = 200,		-- Piety hit for attacking someone who is defending against other religious group
...
NCharacter = {
	...
	CHANGE_AMBITION_YEARS = 0,						-- Delay between being able to pick a new ambition of plot after cancelling
	...
	PORTRAIT_ADULT_MALE_AGE_THRESHOLD = 12,			-- Male child to adult age portrait switch
	PORTRAIT_ADULT_FEMALE_AGE_THRESHOLD = 12,		-- Female child to adult age portrait switch
	...
	AGE_OF_ADULTHOOD = 12,							-- Can rule at this age. Also determines when a proper portrait is shown.
	...
	NATURAL_DEATH_CHANCE_AGE_10 = 2,				-- Natural deaths per decade out of 10000 people: Age 10-19
	NATURAL_DEATH_CHANCE_AGE_20 = 30,				-- Natural deaths per decade out of 10000 people: Age 20-29
	NATURAL_DEATH_CHANCE_AGE_30 = 40,				-- Natural deaths per decade out of 10000 people: Age 30-39
	NATURAL_DEATH_CHANCE_AGE_40 = 102,				-- Natural deaths per decade out of 10000 people: Age 40-49
	NATURAL_DEATH_CHANCE_AGE_50 = 200,				-- Natural deaths per decade out of 10000 people: Age 50-59
	NATURAL_DEATH_CHANCE_AGE_60 = 640,				-- Natural deaths per decade out of 10000 people: Age 60-69
	...
	NATURAL_DEATH_CHANCE_AGE_90 = 10000,				-- Natural deaths per decade out of 10000 people: Age 90-99
	NATURAL_DEATH_CHANCE_AGE_100 = 10000,			-- Natural deaths per decade out of 10000 people: Age 100+
...
NMilitary = {
	...
	NAVAL_ATTRITION = 0.01,							-- Attrition taken monthly by units loaded on ships
